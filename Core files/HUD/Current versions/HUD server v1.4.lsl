...
state Idle {
	...
	touch_start(integer Count) {
		...
		if (IsRestricted(TouchId)) {	// they don't satisfy the restriction test
			llDialog(TouchId, "\n\nSorry, you don't have the correct permissions to use this object.", [ "OK" ], -9999991919);
			return;
		}
		AvId = TouchId;
